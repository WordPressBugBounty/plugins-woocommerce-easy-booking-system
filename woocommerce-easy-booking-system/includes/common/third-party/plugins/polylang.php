...
function wceb_pll_ajax_on_front() {
	...
	if ( isset( $_GET['wceb-ajax'] ) && 'set_booking_session' === sanitize_text_field( wp_unslash( $_GET['wceb-ajax'] ) ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended, 
