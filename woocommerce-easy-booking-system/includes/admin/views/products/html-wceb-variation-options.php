...
<div class="booking_variation_data show_if_variation_bookable">
	...
	<p class="form-row form-row-first">
		<label for="_var_number_of_dates[<?php echo absint( $loop ); ?>]">
			<?php esc_html_e( 'Number of dates to select', 'woocommerce-easy-booking-system' ); ?>
		</label>
		<select name="_var_number_of_dates[<?php echo absint( $loop ); ?>]" id="_var_number_of_dates[<?php echo absint( $loop ); ?>]" class="select short booking_dates">
	...
	<div class="show_if_two_dates">
		...
		<p class="form-row form-row-last">
			...
			<label for="_var_booking_duration[<?php echo absint( $loop ); ?>]">
		...
		<p class="form-row form-row-first">
			...
			<label for="_var_booking_min[<?php echo absint( $loop ); ?>]">
		...
		<p class="form-row form-row-last">
			...
			<label for="_var_booking_max[<?php echo absint( $loop ); ?>]">
	...
	<p class="form-row form-row-first">
		...
		<label for="_var_first_available_date[<?php echo absint( $loop ); ?>]">
	...
	<p class="form-row form-row-last">
		...
		<label for="_var_last_available_date[<?php echo absint( $loop ); ?>]">
