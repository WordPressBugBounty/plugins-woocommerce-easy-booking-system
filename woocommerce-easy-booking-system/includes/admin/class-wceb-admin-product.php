...
class Admin_Product {
	...
	public function save_product_booking_options( $post_id ) {
		...
		$booking_data = array(
			...
			'dates'                => isset( $_POST['_number_of_dates'] ) ? wp_unslash( $_POST['_number_of_dates'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
			'booking_min'          => isset( $_POST['_booking_min'] ) ? wp_unslash( $_POST['_booking_min'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
			'booking_max'          => isset( $_POST['_booking_max'] ) ? wp_unslash( $_POST['_booking_max'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
			'first_available_date' => isset( $_POST['_first_available_date'] ) ? wp_unslash( $_POST['_first_available_date'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
			'last_available_date'  => isset( $_POST['_last_available_date'] ) ? wp_unslash( $_POST['_last_available_date'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
			'booking_duration'     => isset( $_POST['_booking_duration'] ) ? wp_unslash( $_POST['_booking_duration'] ) : '', // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- Sanitized in wceb_save_product_booking_options(), nonce checked by WooCommerce
		);
